...
type NativeTimeAccessibility = {
  ...
  setAutomaticTime: (enabled: boolean) => Promise<AccessibilityStatus>;
...
export async function getAccessibilityStatus(): Promise<AccessibilityStatus> { return nativeModule ? nativeModule.getStatus() : webStatus; }
...
export async function setAutomaticTime(enabled: boolean): Promise<AccessibilityStatus> {
